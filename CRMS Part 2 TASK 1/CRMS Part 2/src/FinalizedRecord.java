public class FinalizedRecord extends ProcessedRecord {
    ...
    public FinalizedRecord(Client client, Car car, Agent agent,
        ...
        if (paymentDetails == null) { throw new IllegalArgumentException("Payment details cannot be null"); }
        if (pickupDetails == null)  { throw new IllegalArgumentException("Pickup details cannot be null"); }
    ...
    public PickupDetails getPickupDetails()   { return pickupDetails; }
