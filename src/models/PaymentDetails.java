...
public class PaymentDetails {
    ...
    public PaymentDetails(double depositPaid, double totalRentalCost, String paymentMethod) {
        if (depositPaid < 0) {
            throw new IllegalArgumentException("Deposit paid cannot be negative");
        }
        if (depositPaid > totalRentalCost) {
            throw new IllegalArgumentException("Deposit cannot be greater than total rental cost");
        }
        if (totalRentalCost < 0) {
            throw new IllegalArgumentException("Total rental cost cannot be negative");
        }
